package com.seven.spark.project.spark

import com.seven.spark.project.dao.{CourseSearchClickCountDAO, CourseClickCountDAO}
import com.seven.spark.project.domain.{CourseSearchClickCount, CourseClickCount, ClickLog}
import com.seven.spark.project.util.DataUtils
