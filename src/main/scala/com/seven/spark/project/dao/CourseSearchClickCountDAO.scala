package com.seven.spark.project.dao

import com.seven.spark.project.domain.{CourseSearchClickCount, CourseClickCount}
import com.seven.spark.hbase.HBaseUtils
